        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 sm:p-10 shadow-2xl">
          ...
          <form action={formAction} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={pending}
              className="group relative w-full py-3.5 bg-brand-gold text-brand-black font-extrabold rounded-lg text-sm uppercase tracking-wide overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-brand-gold/40 disabled:opacity-70 disabled:cursor-not-allowed hover:-translate-y-0.5"
            >
